...
public class WhileLoop {
	public static void main (String[] args) {
		/*
		 * While. el cilco While ejecuta continuamente un bloque de codigo hasta que se cumpla 
		 * while (expresion){
		...
		*/
		...
		4. Guardar en una variable el numero incia la cuenta (1)
		...
		*/
		...
		//3.
		int numFinal = nombreScanner.nextInt();
		//4.
		int numInicial = 1;
		//5. 
